<?php
/**
 * Payment Failed Email Template (Plain Text)
 *
...
if (!empty($link_data['url'])) {
    echo "=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n";
    echo esc_html__('Retry Payment', 'wc-flex-pay') . "\n";
    echo "=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n\n";

    echo esc_html__('Please use this link to try the payment again:', 'wc-flex-pay') . "\n";
